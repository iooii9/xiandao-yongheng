    ...
    if (useRawMode) {
      ...
      const rawResponse = await tavernHelper.generateRaw({
        ordered_prompts: [
          ...
          // 8. 示例
          { role: 'system', content: `【示例】：\n原文："青云峰遇星尘。他帮我击退魔修。我很感激。他送我聚气丹。我们成为朋友。三天后藏经阁再遇。他求教剑法。我教他基础剑诀。"\n正确："三日前我在青云峰遇到了星尘，当时有魔修来袭，星尘出手相助，我才得以脱险。我很感激他的恩德，于是我们结为道友。星尘还赠予我一枚聚气丹，我们的情谊更加深厚。后来在藏经阁重逢，星尘向我求教剑法，我便传授了他基础剑诀。"\n错误："我继续修炼，又遇到了新的机缘..."（❌ 编造了原文没有的内容）` },
