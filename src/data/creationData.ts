// 仙道永恒 by 星尘 | github.com/starDustStudio | CC BY-NC-SA 4.0
...
export const LOCAL_TALENT_TIERS: Omit<TalentTier, 'source'>[] = [
  ...
  { id: 2, name: '凡人', description: '芸芸众生中的一员，不好不坏，有缘可入仙道永恒。若有大机缘，亦可成就一番事业。', total_points: 20, rarity: 2, color: '#E2E8F0' },
